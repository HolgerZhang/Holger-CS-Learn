...
public abstract class ActivityBaseFrame extends JFrame {
    // 通用属性
    ...
    public static final Dimension WINDOW_MIDDLE = new Dimension(740, 400);   // 种窗口
    public static final Dimension WINDOW_SMALL = new Dimension(500, 600);   // 小窗口
    public static final Dimension WINDOW_SMALLER = new Dimension(450, 340);   // 小窗口
    ...
    protected ActivityBaseFrame(String title, Dimension size, Manager manager) {
        super(title);
        ...
        this.addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent event) {
                ActivityBaseFrame.this.finish();   // 调用 finish 方法关闭窗口
            }
        });
        try {
